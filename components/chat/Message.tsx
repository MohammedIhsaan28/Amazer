      ...
      >
        ...
        >
          {message.isUserMessage ? (
            <Icon.user aria-hidden className="h-3/4 w-3/4 fill-zinc-200 text-zinc-200" />
          ) : (
            <Icon.logo aria-hidden className="h-3/4 w-3/4 fill-zinc-300 text-zinc-300" />
          )}
        </div>

        <div
          className={cn(
            "flex flex-col space-y-2 text-base max-w-[85%] mx-2",
            {
        ...
        >
          ...
          >
            ...
            <div className="text-xs select-none mt-2 w-full text-right opacity-70">
